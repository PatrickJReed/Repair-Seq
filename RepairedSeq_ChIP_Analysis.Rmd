...
dba_1D_Common_Shuffle <- read.delim("~/RepairedSeq/dba_1D_Common2_NEW.shuffle.bed", header=FALSE)
...
peakAnno_dba_1D_Common2Shuffle <- annotatePeak(dba_1D_Common_Shuffle_gr, tssRegion=c(-3000, 3000),TxDb=txdb, annoDb="org.Hs.eg.db")
